                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="ruangan-card">
                                ...
                                @php
                                // Menghapus spasi dan mengubah ke huruf kecil untuk perbandingan yang akurat
                                $ruanganNama = strtolower(trim($ruangan->nama));

                                // Path default ke placeholder
                                $imagePath = 'https://placehold.co/600x400/e2e8f0/334155?text=' . urlencode($ruangan->nama);

                                // --- KONDISI DIPERBARUI SESUAI INFO DEBUG ANDA ---
                                if ($ruanganNama === 'auditorium utama') { // Diubah dari 'audit'
                                $imagePath = asset('images/audit_card.jpg');
                                } elseif ($ruanganNama === 'ruang a 201') { // Diubah dari 'a201'
                                $imagePath = asset('images/a201_card.jpg');
                                } elseif ($ruanganNama === 'ruang b 201') { // Diubah dari 'b201'
                                $imagePath = asset('images/b201_card.jpg');
                                }
                                @endphp
                                <div class="ruangan-card-img" style="background-image: url('{{ $imagePath }}')"></div>
