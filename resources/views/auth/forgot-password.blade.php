    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-branding">
                ...
                <h1>Lupa Password?</h1>
                <p>Kami akan bantu Anda untuk mengatur ulang password.</p>
            </div>

            <div class="login-form-panel">
                <h2>Reset Password</h2>
                <p class="subtitle mb-4 text-sm">
                    Cukup masukkan alamat email Anda dan kami akan mengirimkan link untuk mengatur ulang password Anda.
                </p>
